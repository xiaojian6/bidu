$(function(){
    ...
    //================限价与额度=============================		
        ...
        //      $('.transactionAmount').find('button').html(buy+'<span class="btn_name ">'+'&nbsp'+$('.legal_name').text()+'</span>').removeClass('activesell');  
        ...
        //      $('.transactionAmount').find('button').html(sell+'<span class="btn_name ">'+'&nbsp'+$('.legal_name').text()+'</span>').addClass('activesell')     
        // })
