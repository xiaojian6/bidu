        ...
        H5lock.prototype.storePass = function(psw) {// touchend结束之后对密码和状态的处理
            if (this.pswObj.step == 1) {
                if (this.checkPass(this.pswObj.fpassword, psw)) {
                    ...
                    //console.log(this.pswObj.spassword);
                    var ges1='';
                    var ges2='';
                    for(i in this.pswObj.fpassword){
                       ges1+=this.pswObj.spassword[i].index;
                    }
                    for(i in this.pswObj.spassword){
                       ges2+=this.pswObj.spassword[i].index;
                    }
                    //console.log(ges1);
                    //console.log(ges2);
