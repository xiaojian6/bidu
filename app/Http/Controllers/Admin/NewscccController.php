...
class NewscccController extends Controller
{
    ...
    */
    ...
    {
//        $c_id = intval($request->input('c_id', '15'));
        $c_id = 15;
        ...
        return view('admin.newsccc.index', [
            'data'=> $data,
            'lang_list' => $lang_list,
        ]);
    }
...
//        ]);
        ...
        $news->china_name = $request->input('china_name', "");
        $news->enlish_name = $request->input('enlish_name', "");
        $news->enlish_jian = $request->input('enlish_jian', "");
        $news->create_name = $request->input('create_name', "");
        $news->qk_award = $request->input('qk_award', "");
        $news->qk_time = $request->input('qk_time', "");
        $news->fb_time = $request->input('fb_time', "");
        $news->wk_way = $request->input('wk_way', "");
        $news->sc_price = $request->input('sc_price', "");
        $news->hx_arithmetic = $request->input('hx_arithmetic', "");
        $news->hb_allnumber = $request->input('hb_allnumber', "");
        $news->qw_power = $request->input('qw_power', "");
    ...
    */
    ...
    public function edit(Request $request, $id = 0)
    {
        ...
        return view('admin.newsccc.add', $data);
    }
    ...
    */
    ...
    public function cateIndex(Request $request)
    {
        ...
        return view('admin.newsccc.cateIndex', ['data'=> $data]);
    }
    ...
    */
    ...
    {
        return view('admin.newsccc.cateAdd');
    }
    ...
    */
    ...
    public function cateEdit(Request $request, $id = 0)
    {
        ...
        return view('admin.newsccc.cateAdd', $cate);
    }
    ...
    */
    ...
    public function discussIndex(Request $request, $nId = 0)
    {
        ...
        return view('admin.newsccc.discussIndex', $data);
    }
