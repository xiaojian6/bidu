        ...
        <div class="layui-collapse">
            <div class="layui-colla-item">
                ...
                <div class="layui-colla-content layui-show">
                    ...
                    <div class="layui-form-item">
                        <label for="label_id" class="layui-form-label">标签</label>
                        <div class="layui-input-block">
                            <select name="label_id" lay-verify="required" lay-search>
                                @foreach ($labels as $label)
                                    <option value="{{ $label->id }}" @if ((isset($currency_match) && $currency_match->label_id == $label->id)) selected @endif>{{ $label->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label for="currency_id" class="layui-form-label">推荐榜排序</label>
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" class="layui-input" name="recommended" placeholder="推荐榜排序" value="{{ $currency_match->recommended ?? 0 }}" >
                            </div>
                            <div class="layui-form-mid">数值为正开始显示，且数值越小越靠前</div>
                        </div>
                    </div>
            ...
            <div class="layui-colla-item">
                <h2 class="layui-colla-title">合约交易参数</h2>
                <div class="layui-colla-content layui-show">
                    <div class="layui-form-item">
