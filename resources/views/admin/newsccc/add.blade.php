...
@section('page-content')
	<form class="layui-form" method="POST">
		...
		<div class="layui-form-item">
			<label class="layui-form-label">大写币种名称</label>
			<div class="layui-input-block">
				<input class="layui-input newsName" name="title" lay-verify="required" placeholder="必须输入大写币种名称" type="text" value="@if (isset($news['title'])){{$news['title']}}@endif">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input class="layui-input " name="china_name"  placeholder="请输入中文名" type="text" value="@if (isset($news['china_name'])){{$news['china_name']}}@endif">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">英文名</label>
			<div class="layui-input-block">
				<input class="layui-input " name="enlish_name"  placeholder="请输入英文名" type="text" value="@if (isset($news['enlish_name'])){{$news['enlish_name']}}@endif">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">英文简称</label>
			<div class="layui-input-block">
				<input class="layui-input " name="enlish_jian"  placeholder="请输入英文简称" type="text" value="@if (isset($news['enlish_jian'])){{$news['enlish_jian']}}@endif">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">开发者</label>
			<div class="layui-input-block">
				<input class="layui-input " name="create_name"  placeholder="请输入开发者" type="text" value="@if (isset($news['create_name'])){{$news['create_name']}}@endif">
			</div>
		</div>

		<div class="layui-form-item">
			<label class="layui-form-label">区块奖励</label>
			<div class="layui-input-block">
				<input class="layui-input " name="qk_award"  placeholder="请输入区块奖励" type="text" value="@if (isset($news['qk_award'])){{$news['qk_award']}}@endif">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">区块时间</label>
			<div class="layui-input-block">
				<input class="layui-input " name="qk_time"  placeholder="请输入区块时间" type="text" value="@if (isset($news['qk_time'])){{$news['qk_time']}}@endif">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input class="layui-input " name="fb_time"  placeholder="请输入发布时间" type="text" value="@if (isset($news['fb_time'])){{$news['fb_time']}}@endif">
			</div>
		</div>

		<div class="layui-form-item">
			<label class="layui-form-label">挖矿方式</label>
			<div class="layui-input-block">
				<input class="layui-input " name="wk_way"  placeholder="请输入挖矿方式" type="text" value="@if (isset($news['wk_way'])){{$news['wk_way']}}@endif">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input class="layui-input " name="sc_price"  placeholder="请输入市场价格" type="text" value="@if (isset($news['sc_price'])){{$news['sc_price']}}@endif">
			</div>
		</div>

		<div class="layui-form-item">
			<label class="layui-form-label">核心算力</label>
			<div class="layui-input-block">
				<input class="layui-input " name="hx_arithmetic"  placeholder="请输入核心算力" type="text" value="@if (isset($news['hx_arithmetic'])){{$news['hx_arithmetic']}}@endif">
			</div>
		</div>

		<div class="layui-form-item">
			<label class="layui-form-label">货币总量</label>
			<div class="layui-input-block">
				<input class="layui-input " name="hb_allnumber"  placeholder="请输入货币总量" type="text" value="@if (isset($news['hb_allnumber'])){{$news['hb_allnumber']}}@endif">
			</div>
		</div>

		<div class="layui-form-item">
			<label class="layui-form-label">全网算力</label>
			<div class="layui-input-block">
				<input class="layui-input" name="qw_power"  placeholder="请输入全网算力" type="text" value="@if (isset($news['qw_power'])){{$news['qw_power']}}@endif">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<textarea placeholder="请输入内容摘要" class="layui-textarea" name="abstract">@if (isset($news['keyword'])){{$news['keyword']}}@endif</textarea>
			</div>
		</div>
		<div class="layui-form-item">
...
<script type="text/javascript" src="{{URL('/admin/js/newscccFormSubmit.js?v=').time()}}"></script>
<script>
